...
namespace MotorControlProtocols.OthersOwn
{
    /// <summary>
    /// 牟特自有控制器，与双源协议仅相差故障码和三相电压，其他一样
    /// </summary>
    public class MotorThOwn1 : AbstractMotorControl
    {
        /********************************
         * Intel格式，低位在前，高位在后
         * ******************************/
        ...
        struct Scm_MCU1_Frame1
        {
            ...
            /// 00正常
            /// </summary>
            public byte dualsource_error_code;
        }
        ...
        Scm_MCU1_Frame2 ByteToScmMcu1Frame2(CanStandardData scmCanByte2)
        {
            ...
            scmMcu1Frame2.dualsource_ac_u = (ushort)(scmCanByte2.datas[5] * 256 + scmCanByte2.datas[4]);
        ...
        private string ReceiveErrorTransform(byte errorCode)
        {
            ...
            switch (errorCode)
            {
                ...
                case 0x0B:
                    ...
                    break;
                case 0x0C:
                    errStr = "W相电流中心线偏移量不合理";
                    break;
                case 0x0D:
                    errStr = "三相电流之和不均衡故障";
                    break;
                case 0x0E:
                    errStr = "IGBT短路故障(上下桥同时短路)";
                    break;
                case 0x0F:
                    errStr = "IGBT短路故障(上桥短路)";
                    break;
                case 0x10:
                    errStr = "IGBT短路故障(下桥短路)";
                    break;
                case 0x11:
                    errStr = "三相同时过流故障";
                    break;
                ...
                case 0x50:
                    ...
                    break;
                case 0x51:
                    errStr = "电机温度传感器开路故障或对电源短路";
                    break;
                case 0x52:
                    errStr = "控制板PCB温度传感器对地短路";
                    break;
                case 0x53:
                    errStr = "控制板PCB温度传感器超限短路";
                    break;
                case 0x54:
                    errStr = "控制板PCB温度传感器开路故障或对电源短路";
                    break;
                case 0x55:
                    errStr = "IGBT温度传感器对地短路";
                    break;
                case 0x56:
                    errStr = "IGBT温度传感器超限短路";
                    break;
                case 0x57:
                    errStr = "IGBT温度传感器开路故障或对电源短路";
                    break;
                case 0x58:
                case 0x59:
                case 0x5A:
                ...
                case Scm_MCU1_Frame1.motor1CanId: //反馈第一帧,使能，方向，扭矩，转速，故障
                    {
                        ...
                        recMsg.FeedBkErrorCode = new byte[1] { scmMcu1.dualsource_error_code };
