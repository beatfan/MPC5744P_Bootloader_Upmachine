...
namespace MotorControlProtocols.Hybrid
{
    ...
    /// 适用于 混动电机控制器2
    /// </summary>
    public class HybridTM2:AbstractMotorControl
    {
        /********************************
         * Intel格式，低位在前，高位在后
         * ******************************/
        ...
        struct Scm_EVCU1
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x0C41D3D0;
            /// <summary>
            /// 波特率
            /// </summary>
        ...
        struct Scm_MCU1_Frame1
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x0C42D0D3;
            /// <summary>
            /// 波特率
            /// </summary>
            public const uint baudrate = 250; //250Kbps
        ...
        struct Scm_MCU1_Frame2
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x0C43D0D3;
            /// <summary>
            /// 波特率
            /// </summary>
            public const uint baudrate = 250; //250Kbps
        ...
        struct Scm_MCU1_Frame3
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x1844D0D3;
            /// <summary>
            /// 波特率
            /// </summary>
            public const uint baudrate = 250; //250Kbps
        ...
        struct Scm_MCU1_Frame4
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x1845D0D3;
            /// <summary>
            /// 波特率
            /// </summary>
            public const uint baudrate = 250; //250Kbps
        ...
        struct Scm_MCU1_Frame5
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x1846D0D3;
