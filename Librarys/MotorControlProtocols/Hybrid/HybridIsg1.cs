...
namespace MotorControlProtocols.Hybrid
{
    ...
    /// 适用于 混动发电机控制器1
    /// </summary>
    public class HybridIsg1:AbstractMotorControl
    {
        /********************************
         * Intel格式，低位在前，高位在后
         * ******************************/
        ...
        struct Scm_EVCU1
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x0C61D1D0;
            /// <summary>
            /// 波特率
            /// </summary>
        ...
        struct Scm_MCU1_Frame1
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x0C62D0D1;
            /// <summary>
            /// 波特率
            /// </summary>
            public const uint baudrate = 250; //250Kbps
        ...
        struct Scm_MCU1_Frame2
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x0C63D0D1;
            /// <summary>
            /// 波特率
            /// </summary>
            public const uint baudrate = 250; //250Kbps
        ...
        struct Scm_MCU1_Frame3
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x1864D0D1;
            /// <summary>
            /// 波特率
            /// </summary>
            public const uint baudrate = 250; //250Kbps
        ...
        struct Scm_MCU1_Frame4
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x1865D0D1;
            /// <summary>
            /// 波特率
            /// </summary>
            public const uint baudrate = 250; //250Kbps
        ...
        struct Scm_MCU1_Frame5
        {
            ...
            /// CAN ID
            /// </summary>
            public const uint canId = 0x1866D0D1;
